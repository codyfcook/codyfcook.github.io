...
Assistant Professor, Department of Economics, Yale University \hfill 2025-


% EDUCATION 
\section{Education}
Ph.D. in Economics, {Stanford GSB} \hfill 2024\\[0.3em] %\vspace{-0.5em}
%\begin{itemize}\small
%    \item[]\emph{Primary advisors: Rebecca Diamond and Matthew Gentzkow}
...
with Pearl Z. Li. November 2025\\
\emph{R\&R, American Economic Review}\\

\href{https://www.cody-cook.com/papers/nyc_congestion_pricing.pdf}{\textbf{The Network-Wide Effects of Congestion Pricing: Evidence from New York City}} \\ 
with Aboudy Kreidieh, Shoshana Vasserman, Hunt Allcott, Neha Arora, Andrew Tomkins, Eray Turkel, and Freek van Sambeek. August 2026 \\

\href{https://www.cody-cook.com/papers/affordable_housing_location.pdf}{\textbf{Where to Build Affordable Housing? Evaluating the Trade-offs of Location}} \\ 
with Pearl Z. Li and Ariel J. Binder. June 2026 \\
...
Cities, Housing \& Society Lab, Stanford GSB \hfill 2024- 
...
% REFEREEING
\section{Refereeing}
Journal of Political Economy, American Economic Review, Quarterly Journal of Economics, Journal of Public Economics, American Economic Journal: Applied, American Economic Journal: Economic Policy, Journal of Human Resources, Journal of Urban Economics, Review of Economics and Statistics, Economic Journal, Journal of Economic Behavior \& Organization, Journal of Political Economy: Microeconomics, International Labour Review, Journal of Labor Economics
...
\hspace*{-0.75em}\begin{tabular}{p{12cm}r} 
    % 2026
    \vspace{-0.3em}
    \emph{Presented or scheduled:} TRB Annual Meeting, WBEC, Yale IO, Boston College, NY Federal Reserve, Harvard, Massachusetts HLC, UEAs, CUNY & 2026 \\ [2em]
    \emph{Co-organizer:} NYU-Yale-Columbia Housing Day\\[1em]

    % 2025
    \emph{Presented:} ASSA conference, Monash University, University of Melbourne, University of Tokyo, Kochi IO Workshop, NBER Public Spring Meeting, Hong Kong University, Econometric Society World Congress, Stanford GSB, UK GES, UIUC, NBER Public Fall Meeting, Conference on Urban and Regional Economics (LSE), Columbia & 2025 \\ [5em]
    \emph{Co-organized:} NYU-Yale-Columbia Housing Day (x2); Junior Spatial Conference \\[1em]
    
    % 2024 
    \emph{Presented:} UBC Sauder, UPenn Wharton, Cornell, Northwestern, UW Madison, Yale, NYU Furman Center, Duke, Berkeley Haas, National University of Singapore, MIT (Policy Impacts), London School of Economics, UPenn  & 2024 \\[2.7em]
    \emph{Co-organized:} NYU-Yale-Columbia Housing Day \\[1em]
